import { GlobalMetadata, Media, PlatformInfo, SimilarRDT, SimilarYT } from "../common/types";
...
export class RootOrchestrator {
    ...
    static async processOrchestrator(key: string, platform: string): Promise<GlobalMetadata> {
    ...
    static extractTopTenMedias(ytVideos:SimilarYT[], rdtVideos: SimilarRDT[] = []):Media[] {
        // Input validation
