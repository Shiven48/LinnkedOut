      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Submit URLs from YouTube, Reddit, and other platforms to curate
            content for your feed. Our AI will find similar posts and categorize
            them automatically.
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-darker rounded-2xl p-6 border border-gray-800 shadow-md shadow-golden">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-semibold text-white">
                Content URL<sup className="text-golden text-xl mt-1">*</sup>
              </h2>
            ...
            <div className="space-y-4">
              <div className="flex relative gap-2">
                ...
                <button
                  type="button"
                  disabled={
                    formData.url.length > 5 || urlValidation.isValid === false
                  }
                  onClick={addUrl}
            ...
            <div className="grid grid-cols-3 md:grid-cols-3 gap-3">
              {categories().map((category: Category) => (
                <button
                  ...
                  type="button"
                  onClick={() =>
                    setFormData({ ...formData, category: category.title })
                  }
                ...
                >
                  <Image
                    ...
                    alt={category.title}
                  />
                  <div className="text-dark-golden font-medium text-sm">
                    {category.title}
                  </div>
                </button>
              ))}
          ...
          <div className="bg-darker rounded-2xl p-6 border border-gray-800 shadow-md shadow-golden">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-sm text-red-500">
                (Add your favorite topics as tags to see related content)
              </span>
            </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Automatically discover related posts and videos
                  </p>
                </div>
                <button
                  type="button"
                  onClick={() =>
                    setFormData({ ...formData, fetchSimilar: true })
                  }
                  ...
                  <div className="flex gap-3">
                    {["low", "medium", "high"].map((level) => (
                      <button
                        ...
                        type="button"
                        onClick={() =>
                          setFormData({ ...formData, similarityLevel: level })
                        }
          ...
          <div className="flex justify-center pt-4">
            <button
              ...
              disabled={
                !formData.url || urlValidation.isValid !== true || isSubmitting
              }
